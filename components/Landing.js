    ...
    <section id="home" className='md:flex md:justify-between md:items-center md:h-full gap-16 py-10'> 
        ...
        <div className='md:order-2 flex justify-center basis-3/5 z-10 mt-16 md:mt-32'>
            {isAboveMediumScreens ? (
                ...
                <img src="lgbt2.jpg" alt="profile" 
                    className='hover:filter hover:saturate-200 transition duration-500 z-10 w-56 md:w-64 max-w-[400px] md:max-w-[600px] h-96 '
                />
        ...
        {/* Content section */}
        <div className=' z-30 basis-2/5 mt-12 md:mt-32 md:order-1'>
            <motion.div
                initial="hidden"
                whileInView="visible"
            ...
            >
                ...
                <p className=' mt-10 mb-7 text-sm text-center md:text-start'> 
                    Embracing the unique and beautiful spectrum of identities within the LGBTQ+ community at Rainbow Dot.
                </p>
            </motion.div>
            {/* CTA */}
            <motion.div
